                     ...
                     unsigned char abstraction_flag)
{
  ...
  //  for (eNB_id=0; eNB_id<3; eNB_id++) {
  {
    ...
    if (abstraction_flag==0) {
      ...
      common_vars->tx_buff=(int32_t**)malloc16(fp->nb_antennas_tx*sizeof(int32_t*));// zh add 20170927
	  common_vars->tx_dspdata=(int32_t**)malloc16(fp->nb_antennas_tx*sizeof(int32_t*));// zh add 20171025
      ...
      if (eNB->node_function != NGFI_RCC_IF4p5) {
		...
		//zh add 20171208
        common_vars->rx_buff        = (int32_t**)malloc16(fp->nb_antennas_rx*sizeof(int32_t*) );
      }
